...
function EFFECT:Render()
    if IsValid(self.CSShrinkModel) then
        ...
        render.SetColorModulation(0,200/255,1)
        render.SetBlend(1)
    ...
    if IsValid(self.CSGrowModel) then
        render.SuppressEngineLighting(true)
        render.SetColorModulation(0,175/255,1)
        render.SetBlend(1)
